...
def start_timer():
    ...
    if reps % 2 == 0 and reps != 8:
        ...
        timer_label.config(text="Short Break", fg=PINK,bg=YELLOW, font=(FONT_NAME, 40, "bold"))
    elif reps % 8 == 0:
        ...
        count_down(work_sec)
        timer_label.config(text="Work Time", fg=BLUE, bg=YELLOW, font=(FONT_NAME, 40, "bold"))
...
window.config(padx=100, height=200, bg=YELLOW)
